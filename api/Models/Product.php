...
class Product extends DatabaseConfig
{
  ...
  {
    $sql = "SELECT category.category_name_name, GROUP_CONCAT(products.product_name) AS products
            FROM products
            JOIN category ON products.category_id = category.id
            GROUP BY category.category_name_name";
  ...
  public function findById($id)
  {
    $sql = "SELECT products.id, products.product_name, category.category_name AS category
            FROM products
            JOIN category ON products.category = category.id
            WHERE products.id = ?"; // Specify 'products.id'
